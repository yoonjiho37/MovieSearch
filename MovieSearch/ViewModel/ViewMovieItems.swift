...
class ViewMovieItems {
    ...
    init(movieId: String, title: String, directorNm: String, actors: Actors, company: String, plot: String, runtime: String, rating: String, genre: String, posterURL: [String], rank: Int) {
